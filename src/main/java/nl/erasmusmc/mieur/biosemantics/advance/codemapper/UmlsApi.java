...
public class UmlsApi {
    ...
    private static final List<String> VOCABULARIES_WITH_DEFINITIONS = Arrays.asList("CCC", "CHV", "HL7V3.0",
            "MEDLINEPLUS", "NCI");
    ...
    private static UmlsApi instance = null;
    private static Logger logger = Logger.getLogger("AdvanceCodeMapper");

    public static UmlsApi getInstance() {
        if (instance == null)
            instance = new UmlsApi();
        return instance;
    }

    public void init(String serviceName, String version, String username, String password,
    ...
    public List<UmlsConcept> getUmlsConcepts(List<String> cuis, List<String> vocabularies) throws CodeMapperException {
        Psf psf = new Psf();
        ...
        for (String cui : cuis) {
            ...
            try {
                ...
                String definition = null;
                {
                    ...
                    for (String voc : VOCABULARIES_WITH_DEFINITIONS)
