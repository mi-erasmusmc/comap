...
# unzip "$SNOMEDZIP1" "$CONCEPT_WILD1" "$RELATIONSHIP_WILD1" "$DESCRIPTION_WILD1" "$LANGUAGE_WILD1"
...
# unzip "$SNOMEDZIP2" "$CONCEPT_WILD2" "$RELATIONSHIP_WILD2" "$DESCRIPTION_WILD2" "$LANGUAGE_WILD2"
...
cat "$CONCEPT1" "$CONCEPT2" > "$CONCEPT3"
cat "$DESCRIPTION1" "$DESCRIPTION2" > "$DESCRIPTION3"
cat "$RELATIONSHIP1" "$RELATIONSHIP2" > "$RELATIONSHIP3"
cat "$LANGUAGE1" "$LANGUAGE2" > "$LANGUAGE3"
